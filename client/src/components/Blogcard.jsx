...
const Blogcard = ({ blog }) => {
  ...
  return (
    ...
    >
      ...
      <span className='ml-5 mt-4 px-3 py-1 inline-block bg-blue-600 rounded-full text-white text-xs'>
        {category}
      </span>
      ...
      <div className='p-5'>
        ...
        <p className='mb-3 text-xs text-gray-500' dangerouslySetInnerHTML={{"__html":description?.slice(0, 80)}}>
